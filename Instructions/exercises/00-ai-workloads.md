...
1. Select **Find models** (or on the **Discovery** page, select the **Models** tab) to view the Microsoft Foundry model catalog.
...
> **Note**: The Computing History agent is provided solely as a simple example of a chat-based agent for this exercise. It is not a supported Microsoft product or service, and should not be replied on for critical work.
