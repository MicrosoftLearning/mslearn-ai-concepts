...
The AI-901 course includes Microsoft conceptual labs from this repo, *<u>and</u>* Microsoft Foundry-based labs from <https://github.com/MicrosoftLearning/mslearn-ai-fundamentals>. In one-day deliveries, you're likely only to have time to include a subset of these labs; and we recommend the Foundry-based ones in the **[mslearn-ai-fundamentals](https://github.com/MicrosoftLearning/mslearn-ai-fundamentals)** repo. However, you may consider using the conceptual labs in tis repo as demo's, as additional further exploration for learners, or as fallback labs in the event of technical issues providing students with access to a functional Azure environment.
